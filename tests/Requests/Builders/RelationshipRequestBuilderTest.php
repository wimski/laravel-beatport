...
class RelationshipRequestBuilderTest extends TestCase
{
    /**
     * @test
     */
    ...
    {
        $builder = new RelationshipRequestBuilder(
            Mockery::mock(Container::class),
            Mockery::mock(ResourceInterface::class),
        );

        static::assertTrue($builder->type()->equals(RequestTypeEnum::RELATIONSHIP()));
    }
    ...
    public function it_returns_a_resource(): void
    {
        ...
        $builder = new RelationshipRequestBuilder(Mockery::mock(Container::class), $resource);
    ...
    {
        $builder = new RelationshipRequestBuilder(Mockery::mock(Container::class), Mockery::mock(ResourceInterface::class));
    ...
    {
        $resourceEnum = Mockery::mock(ResourceTypeEnum::class)
        ...
        $resource = Mockery::mock(ResourceInterface::class)
            ->shouldReceive('type')
            ->once()
            ->andReturn($resourceEnum)
            ->getMock();

        $parentEnum = Mockery::mock(ResourceTypeEnum::class)
        ...
        $parent = Mockery::mock(ResourceInterface::class)
            ->shouldReceive('type')
            ->once()
        ...
        static::assertSame('/lipsum/slug/1/foobars', $builder->path());
    }
    ...
    public function it_adds_a_filter(): void
    {
        ...
        $resource = Mockery::mock(ResourceInterface::class)
            ...
            ->withArgs(function (RequestTypeEnum $type, string $name) {
                return $type->equals(RequestTypeEnum::RELATIONSHIP()) && $name === 'foo';
            })
            ->andReturn($filter)
            ->getMock();
    ...
    public function it_returns_a_request(): void
    {
        ...
        $builder = new RelationshipRequestBuilder($app, $resource);
        $builder->parent($parent)
            ->slug('slug')
            ->id(1);
